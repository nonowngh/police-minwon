...
//		}
	...
	public static String toMessage(ViewBillingDetailBody entity) {
		...
		ByteBufUtils.writeLeftPaddingNumber(buf, NumberUtils.toLong(entity.getBtddtAmt(), 0), 15, true);
		ByteBufUtils.writeLeftPaddingNumber(buf, NumberUtils.toLong(entity.getAftdteAmt(), 0), 15, true);
		...
		ByteBufUtils.writeLeftPaddingNumber(buf, NumberUtils.toLong(entity.getFineCauseDate(), 0), 14, true);
		ByteBufUtils.writeLeftPaddingNumber(buf, NumberUtils.toLong(entity.getViolDate(), 0), 14, true);
		...
		ByteBufUtils.writeLeftPaddingNumber(buf, NumberUtils.toLong(entity.getPayDt(), 0), 14, true);
