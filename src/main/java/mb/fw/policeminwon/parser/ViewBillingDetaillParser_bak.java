...
import mb.fw.policeminwon.entity.ViewBillingDetaillEntity_bak;

/**
 * 경찰청 범칙금 - 과태료 고지내역 상세 조회
 */
public class ViewBillingDetaillParser_bak {
	public static ViewBillingDetaillEntity_bak toEntity(String data) {
		ViewBillingDetaillEntity_bak msg = new ViewBillingDetaillEntity_bak();
        int pos = 0;
    ...
    public static String makeResponeMessage(ViewBillingDetaillEntity_bak req, ViewBillingDetaillEntity_bak res, String resultCode)  throws Exception {
