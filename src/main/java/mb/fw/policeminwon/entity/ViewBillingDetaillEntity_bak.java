 ...
 */
@Data
public class ViewBillingDetaillEntity_bak {
	//헤더
    ...
    public String toFixedLengthString(ViewBillingDetaillEntity_bak req) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
    	ViewBillingDetaillEntity_bak test = new ViewBillingDetaillEntity_bak();
